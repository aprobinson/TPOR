 ...
 * \ingroup traits
 *
 * The TPOR::HDF5FileHandler has many templated member functions. To allow
 ...
 * and complex data types, the TPOR::HDF5TypeTraits struct must be 
 ...
 * the TPOR::UndefinedTypeTraits struct.
 */
 ...
 * TPOR::HDF5FileHandler class member functions.
 *
