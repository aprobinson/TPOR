//---------------------------------------------------------------------------//
//!
//! \file   DWDMMTreatmentPlanner.cpp
    ...
    d_seed_positions()
{
  ...
  typedef BrachytherapyDynamicWeightSeedPosition SeedPosition;
  ...
  // std::list<BrachytherapyDynamicWeightSeedPosition>::const_iterator position,
  //   end_position;
  ...
  // {
  //   std::cout << position->getWeight() << std::endl;
...
void DWDMMTreatmentPlanner::calculateOptimumTreatmentPlan()
{
  std::cout << std::endl << "starting treatment plan optimization..." 
	    << std::endl;
  clock_t start_clock = clock();
  
  std::list<BrachytherapyDynamicWeightSeedPosition>::iterator position;
...
void DWDMMTreatmentPlanner::updateSeedPositions()
{
  std::list<BrachytherapyDynamicWeightSeedPosition>::iterator position,
    end_position;
...
// Print the treatment plan summary
void DWDMMTreatmentPlanner::printTreatmentPlanSummary( std::ostream &os ) const
{
  os.precision( 3 );
