...
// Note: The data from the article (Med. Phys., Vol. 28, No. 8, 2001, p. 1753)
// only has anisotropy data that goes down to 0.5 degrees. To avoid
// extrapolation, the values at 0.5 degrees have been copied at 0.0 degrees.
...
Nucletron130002Seed::anisotropy_function =
  {0.0, 0.5, 1.5, 2.5, 3.5, 4.5, 5.5, 7.5, 10.5, 12.5, 15.5, 17.5, 20.5, 25.5, 
   30.5, 35.5, 40.5, 50.5, 60.5, 70.5, 80.5, 90, // theta values
   0.197, 0.197, 0.200, 0.201, 0.202, 0.213, 0.240, 0.353, 0.410, 0.469, 0.565,
   0.623, 0.700, 0.803, 0.880, 0.937, 0.970, 0.988, 0.966, 0.987, 0.996, 
   1.000, // r0 values
   0.205, 0.205, 0.211, 0.218, 0.246, 0.309, 0.351, 0.371, 0.425, 0.473, 0.543,
   0.588, 0.646, 0.728, 0.797, 0.854, 0.902, 0.973, 1.003, 0.981, 0.995, 
   1.000, // r1 values
   0.248, 0.248, 0.251, 0.268, 0.333, 0.373, 0.384, 0.401, 0.460, 0.502, 0.567,
   0.602, 0.659, 0.729, 0.790, 0.841, 0.886, 0.955, 1.002, 1.013, 0.995, 
   1.000, // r2 values
   0.291, 0.291, 0.297, 0.354, 0.406, 0.420, 0.425, 0.442, 0.499, 0.540, 0.595,
   0.631, 0.679, 0.747, 0.799, 0.844, 0.886, 0.952, 0.998, 1.017, 0.994, 
   1.000, // r3 values
   0.344, 0.344, 0.382, 0.441, 0.463, 0.467, 0.471, 0.495, 0.546, 0.582, 0.633,
   0.663, 0.706, 0.766, 0.815, 0.853, 0.889, 0.951, 0.991, 1.016, 1.013, 
   1.000, // r4 values
   0.388, 0.388, 0.441, 0.483, 0.499, 0.508, 0.511, 0.535, 0.580, 0.617, 0.661,
   0.689, 0.728, 0.783, 0.828, 0.866, 0.898, 0.956, 0.991, 1.019, 1.019, 
   1.000, // r5 values
   0.464, 0.464, 0.519, 0.552, 0.557, 0.559, 0.562, 0.581, 0.631, 0.657, 0.695,
   0.723, 0.754, 0.799, 0.844, 0.879, 0.907, 0.955, 0.993, 1.014, 1.018, 
   1.000, // r6 values
   0.515, 0.515, 0.553, 0.580, 0.591, 0.594, 0.599, 0.616, 0.654, 0.680, 0.715,
   0.739, 0.769, 0.814, 0.852, 0.882, 0.908, 0.955, 0.991, 1.008, 1.019, 
   1.000, // r7 values
   0.569, 0.569, 0.620, 0.635, 0.639, 0.641, 0.644, 0.668, 0.699, 0.716, 0.745,
   0.763, 0.792, 0.836, 0.867, 0.892, 0.918, 0.958, 0.986, 1.011, 1.018, 
   1.000, // r8 values
   0.615, 0.615, 0.648, 0.655, 0.658, 0.667, 0.671, 0.685, 0.719, 0.731, 0.762,
   0.788, 0.810, 0.840, 0.871, 0.903, 0.926, 0.959, 0.987, 1.006, 1.014,
   1.000 // r9 values
  };
