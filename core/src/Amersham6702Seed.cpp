...
const boost::array<double,16*2> Amersham6702Seed::radial_dose_function =
				      ...
				      const double z ) const
{
  ...
  double radial_dose_function_value = 
    BrachytherapySeed::evaluateRadialDoseFunction( 
			      ...
			      Amersham6702Seed::radial_dose_function.size()/2,
  ...
  double anisotropy_function_value = 
    BrachytherapySeed::evaluateAnisotropyFunction( 
			  ...
			  Amersham6702Seed::anisotropy_function.size()/7,
			  Amersham6702Seed::anisotropy_function_radii.size() );
...
double Amersham6702Seed::getTotalDose( const double x, 
				       ...
				       const double z ) const
{
  return getDoseRate( x, y, z )/Amersham6702Seed::decay_constant;
}
