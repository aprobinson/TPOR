//---------------------------------------------------------------------------//
//!
//! \file   tstDraximageLS1Seed.cpp
//! \author Alex Robinson
//! \brief  DraximageLS1Seed class unit tests.
//!
//---------------------------------------------------------------------------//
...
BOOST_AUTO_TEST_CASE( getSeedType )
{
  boost::shared_ptr<TPOR::BrachytherapySeed> 
    seed( new TPOR::DraximageLS1Seed( 1.0 ) );
...
BOOST_AUTO_TEST_CASE( getDoseRate )
{
  ...
  BOOST_CHECK_EQUAL( dose_rate, 0.972 );
}
...
BOOST_AUTO_TEST_CASE( getTotalDose )
{
  ...
  BOOST_CHECK_CLOSE( total_dose, 1999.1182808832, 1e-9 );
}

//---------------------------------------------------------------------------//
// end tstDraximageLS1Seed.cpp
//---------------------------------------------------------------------------//
