//---------------------------------------------------------------------------//
//!
//! \file   tstAmersham6702Seed.cpp
//! \author Alex Robinson
//! \brief  Amersham6702Seed class unit tests.
//!
//---------------------------------------------------------------------------//
...
BOOST_AUTO_TEST_CASE( getSeedType )
{
  boost::shared_ptr<TPOR::BrachytherapySeed> 
    seed( new TPOR::Amersham6702Seed( 1.0 ) );
...
BOOST_AUTO_TEST_CASE( getTotalDose )
{
  ...
  BOOST_CHECK_CLOSE( total_dose, 2130.747468101793, 1e-9 );
}

//---------------------------------------------------------------------------//
// end tstAmersham6702Seed.cpp
//---------------------------------------------------------------------------//
