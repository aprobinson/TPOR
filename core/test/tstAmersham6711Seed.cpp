//---------------------------------------------------------------------------//
//!
//! \file   tstAmersham6711Seed.cpp
//! \author Alex Robinson
//! \brief  Amersham6711Seed class unit tests.
//!
//---------------------------------------------------------------------------//
...
BOOST_AUTO_TEST_CASE( getSeedType )
{
  boost::shared_ptr<TPOR::BrachytherapySeed> 
    seed( new TPOR::Amersham6711Seed( 1.0 ) );
...
BOOST_AUTO_TEST_CASE( getDoseRate )
{
  ...
  BOOST_CHECK_EQUAL( dose_rate, 0.965 );
}
...
BOOST_AUTO_TEST_CASE( getTotalDose )
{
  ...
  BOOST_CHECK_CLOSE( total_dose, 1984.721338531, 1e-9 );
}

//---------------------------------------------------------------------------//
// end tstAmersham6711Seed.cpp
//---------------------------------------------------------------------------//
