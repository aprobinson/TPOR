//---------------------------------------------------------------------------//
//!
//! \file   tstNASIMED3633Seed.cpp
//! \author Alex Robinson
//! \brief  NASIMED3633Seed class unit tests.
//!
//---------------------------------------------------------------------------//
...
BOOST_AUTO_TEST_CASE( getSeedType )
{
  boost::shared_ptr<TPOR::BrachytherapySeed> 
    seed( new TPOR::NASIMED3633Seed( 1.0 ) );

  TPOR::BrachytherapySeedType seed_type = seed->getSeedType();

  BOOST_CHECK_EQUAL( seed_type, TPOR::NASI_MED_3633_SEED );
}
...
BOOST_AUTO_TEST_CASE( getDoseRate )
{
  ...
  BOOST_CHECK_EQUAL( dose_rate, 0.688 );
}
...
BOOST_AUTO_TEST_CASE( getTotalDose )
{
  ...
  BOOST_CHECK_CLOSE( total_dose, 404.75587273306, 1e-9 );
}

//---------------------------------------------------------------------------//
// end tstNASIMED3633Seed.cpp
//---------------------------------------------------------------------------//
