//---------------------------------------------------------------------------//
//!
//! \file   tstIsoAidIAI125ASeed.cpp
//! \author Alex Robinson
//! \brief  IsoAidIAI125ASeed class unit tests.
//!
//---------------------------------------------------------------------------//
...
BOOST_AUTO_TEST_CASE( getSeedType )
{
  boost::shared_ptr<TPOR::BrachytherapySeed> 
    seed( new TPOR::IsoAidIAI125ASeed( 1.0 ) );
...
BOOST_AUTO_TEST_CASE( getDoseRate )
{
  ...
  BOOST_CHECK_EQUAL( dose_rate, 0.981 );
}
...
BOOST_AUTO_TEST_CASE( getTotalDose )
{
  ...
  BOOST_CHECK_CLOSE( total_dose, 2017.6286353358, 1e-9 );
}

//---------------------------------------------------------------------------//
// end tstIsoAidIAI125ASeed.cpp
//---------------------------------------------------------------------------//
