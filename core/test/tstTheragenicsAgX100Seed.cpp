//---------------------------------------------------------------------------//
//!
//! \file   tstTheragenicsAgX100Seed.cpp
//! \author Alex Robinson
//! \brief  TheragenicsAgX100Seed class unit tests.
//!
//---------------------------------------------------------------------------//
...
BOOST_AUTO_TEST_CASE( getSeedType )
{
  boost::shared_ptr<TPOR::BrachytherapySeed> 
    seed( new TPOR::TheragenicsAgX100Seed( 1.0 ) );

  TPOR::BrachytherapySeedType seed_type = seed->getSeedType();

  BOOST_CHECK_EQUAL( seed_type, TPOR::THERAGENICS_AGX100_SEED );
}
...
BOOST_AUTO_TEST_CASE( getDoseRate )
{
  ...
  BOOST_CHECK_EQUAL( dose_rate, 0.943 );
}
...
BOOST_AUTO_TEST_CASE( getTotalDose )
{
  ...
  BOOST_CHECK_CLOSE( total_dose, 1939.4738054247014, 1e-9 );
}

//---------------------------------------------------------------------------//
// end tstTheragenicsAgX100Seed.cpp
//---------------------------------------------------------------------------//
