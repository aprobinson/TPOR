//---------------------------------------------------------------------------//
//!
//! \file   tstIBt1251LSeed.cpp
//! \author Alex Robinson
//! \brief  IBt1251LSeed class unit tests.
//!
//---------------------------------------------------------------------------//
...
BOOST_AUTO_TEST_CASE( getSeedType )
{
  boost::shared_ptr<TPOR::BrachytherapySeed> 
    seed( new TPOR::IBt1251LSeed( 1.0 ) );
...
BOOST_AUTO_TEST_CASE( getDoseRate )
{
  ...
  BOOST_CHECK_EQUAL( dose_rate, 1.038 );
}
...
BOOST_AUTO_TEST_CASE( getTotalDose )
{
  ...
  BOOST_CHECK_CLOSE( total_dose, 2134.8608802023, 1e-9 );
}

//---------------------------------------------------------------------------//
// end tstIBt1251LSeed.cpp
//---------------------------------------------------------------------------//
